const { pool } = require('../config/db'); // Pastikan destructure { pool }
...
// 2. TAMBAH MENU BARU (Dengan Debugging Lengkap)
const addMenu = async (req, res) => {
  // --- LOGGING DEBUGGING (Supaya tau data masuk atau tidak) ---
  ...
  try {
    ...
    // 🚨 LOGGING ERROR LENGKAP (PENTING!)
    // Ini akan mengubah [object Object] menjadi teks yang bisa dibaca
